...
class TipoUsuario extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('Tipo_Usuario, Descripcion', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'menuUsuarios' => array(self::HAS_MANY, 'MenuUsuario', 'Tipo_Usuario_ID'),
			'usuarioses' => array(self::HAS_MANY, 'Usuarios', 'Tipo_Usuario_ID'),
		);
	}
